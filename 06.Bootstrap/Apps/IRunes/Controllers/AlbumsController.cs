    ...
    public class AlbumsController : BaseController
    {
        ...
        public IHttpResponse All(IHttpRequest request)
        {
            ...
            else
            {
                ...
                {
                    result.AppendLine($"<h5><a href=\"/albums/details?id={album.Id}\">{album.Name}</a></h5>");
                }
            }
        ...
        public IHttpResponse DoCreate(IHttpRequest request)
        {
            ...
            string albumName = WebUtility.UrlDecode(request.FormData["name"].ToString());
        ...
        public IHttpResponse Details(IHttpRequest request)
        {
            ...
            else
            {
                ...
                {
                    result.AppendLine($"<li><h5><strong>{counter}. </strong><a href=\"/tracks/details?id={track.Id}\"><em>{track.Name}</em></a></h5></li>");
                    counter++;
                }
